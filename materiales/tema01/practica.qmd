...
Ahora crearemos una estructura de carpetas para mantener todo organizado. Dentro de su proyecto, cree las siguientes carpetas:
...
1.  Cree un nuevo script usando `Ctrl+Shift+N` o `File > New File > R Script`
...
-   Use rutas relativas siempre que sea posible
-   Reserve el uso de rutas absolutas para casos especiales.
